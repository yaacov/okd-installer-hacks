...
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-0.ostest.test.metalkube.org --for=condition=Ready=false --timeout=5m
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-0.ostest.test.metalkube.org --for=condition=Ready --timeout=5m
...
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-1.ostest.test.metalkube.org --for=condition=Ready=false --timeout=5m
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-1.ostest.test.metalkube.org --for=condition=Ready --timeout=5m
...
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-2.ostest.test.metalkube.org --for=condition=Ready=false --timeout=5m
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-2.ostest.test.metalkube.org --for=condition=Ready --timeout=5m
...
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-3.ostest.test.metalkube.org --for=condition=Ready=false --timeout=5m
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-3.ostest.test.metalkube.org --for=condition=Ready --timeout=5m
...
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-4.ostest.test.metalkube.org --for=condition=Ready=false --timeout=5m
oc --kubeconfig ~dev/dev-scripts/ocp/ostest/auth/kubeconfig wait node worker-4.ostest.test.metalkube.org --for=condition=Ready --timeout=5m
